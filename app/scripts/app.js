...
var wapApp = angular
  ...
  .config(function ($stateProvider, $urlRouterProvider, $httpProvider) {
    ...
    .state('auction', {
        ...
        controller: '',
        url:"/marketing/auction/auction.html"
      })
     .state('auction-hall', {
    ...
    .state('auction-details', {
        ...
        controller: '',
        url:"/marketing/auction/auction-details.html?id&gid&key"
      })
    .state('auction-signup', {
     ...
     .state('auction-finalmoney', {
    	  templateUrl: 'views/marketing/auction/auction-finalmoney.html',
    	  controller: '',
    	  url:"/auction-finalmoney.html?id&gid"
      })
    .state('shareproduct', {
